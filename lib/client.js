...
function executorLabel(task) {
  return task.executorLabel !== void 0 && task.executorLabel !== "" ? task.executorLabel : task.executorKey;
}
...
function diffTaskStatuses(baselineGroups, prevStatus, reminded, groupId, tasks) {
  const reminders = [];
  ...
  for (const task of tasks) {
    ...
    if (prev !== void 0 && prev !== task.status && REMIND_STATUSES.has(task.status) && !reminded.has(`${key}:${task.status}`)) {
...
function notifyDesktop(reminders) {
  if (typeof Notification === "undefined" || Notification.permission !== "granted") return;
  if (typeof document !== "undefined" && !document.hidden) return;
  for (const reminder of reminders) {
    try {
      new Notification(`CoAgentHub \u4EFB\u52A1${statusLabel2(reminder.status)}`, {
...
function CoAgentHubTaskPanel({ apiBase = DEFAULT_API_BASE, onDetailChange, defaultGroupId }) {
  ...
  const [reminders, setReminders] = (0, import_react2.useState)([]);
  const baselineGroupsRef = (0, import_react2.useRef)(/* @__PURE__ */ new Set());
  const prevStatusRef = (0, import_react2.useRef)(/* @__PURE__ */ new Map());
  const remindedRef = (0, import_react2.useRef)(/* @__PURE__ */ new Set());
  const reminderTimersRef = (0, import_react2.useRef)(/* @__PURE__ */ new Map());
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: CoAgentHubTaskPanel_default.content, "aria-label": "CoAgentHub \u4EFB\u52A1\u9762\u677F", children: [
    ...
    reminders.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: CoAgentHubTaskPanel_default.reminderArea, children: reminders.map((reminder) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
      "div",
      {
        className: CoAgentHubTaskPanel_default.reminder,
        "data-status": reminder.status,
        role: "status",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: CoAgentHubTaskPanel_default.reminderStatus, children: statusLabel2(reminder.status) }),
          reminder.executor !== "" && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: CoAgentHubTaskPanel_default.reminderExecutor, children: reminder.executor }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: CoAgentHubTaskPanel_default.reminderSummary, children: reminder.summary }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            "button",
            {
              type: "button",
              className: CoAgentHubTaskPanel_default.reminderClose,
            ...
            "button",
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: CoAgentHubTaskPanel_default.rowMain, children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: CoAgentHubTaskPanel_default.rowTop, children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: CoAgentHubTaskPanel_default.executor, children: executorLabel(task) }),
...
var CoAgentHubSettings_default = { "content": "c1e28c7e8_content", "header": "cf695c204_header", "title": "c1dbb162d_title", "form": "cb7296f84_form", "field": "c7eec46df_field", "label": "cfc4ba57d_label", "input": "c891e3397_input", "actions": "ce1d0ea1b_actions", "save": "c9393f387_save", "saved": "c4d296080_saved", "error": "cb05a4758_error", "wsSection": "cca83d3c8_wsSection", "wsTitle": "cf5cc1a58_wsTitle", "wsStatus": "c31eb57bc_wsStatus", "wsRule": "c28f21ac1_wsRule", "wsMeta": "c3317bae3_wsMeta", "wsNote": "cd57336ea_wsNote", "wsError": "c53032779_wsError", "wsForm": "c6612d5c5_wsForm", "wsResult": "c155f8e42_wsResult", "wsOk": "c08dc1d46_wsOk", "wsFailures": "c6b8cb422_wsFailures" };
...
function CoAgentHubSettings({ onSaved }) {
  ...
  const handleSubmit = (event) => {
    event.preventDefault();
    void saveSettings({
      apiBase: apiBase.trim() === "" ? void 0 : apiBase.trim(),
      participantId: participantId.trim() === "" ? void 0 : participantId.trim()
    }).then(
      () => {
...
function CoAgentHubPanel({ apiBase = DEFAULT_API_BASE }) {
  ...
  const [activeGroupId, setActiveGroupId] = (0, import_react5.useState)(() => readActiveGroupId());
  ...
  (0, import_react5.useEffect)(() => {
    ...
    if (saved !== null) {
      ...
      fetchSettings().then(
        (settings) => {
          if (alive && settings.activeGroupId !== void 0 && settings.activeGroupId !== "") {
    ...
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: CoAgentHubPanel_default.workspaceBar, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
            "select",
            {
              ...
              "aria-label": "\u5F53\u524D\u5DE5\u4F5C\u533A",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: "", children: "\u672A\u9009\u62E9" }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: CoAgentHubPanel_default.body, children: [
          ...
          tab === "settings" && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(CoAgentHubSettings, { onSaved: () => setReloadKey((v) => v + 1) })
        ] }),
