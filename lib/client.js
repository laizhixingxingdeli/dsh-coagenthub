...
var CoAgentHubPanel_default = { "panel": "c03bc34d0_panel", "header": "c75a5b6d7_header", "title": "cc955129f_title", "tabs": "ca58e5d96_tabs", "tab": "c2aaa67ff_tab", "body": "c3be1c85d_body" };
...
var CoAgentHubTaskPanel_default = { "content": "c25be28dd_content", "toolbar": "c38ad2ff0_toolbar", "groupSelect": "c8aa7dc30_groupSelect", "refresh": "cb15b26ee_refresh", "body": "c97a1d0d0_body", "list": "c325fa5fe_list", "row": "c41a64928_row", "rowMain": "c57eff48d_rowMain", "rowTop": "c64bff05d_rowTop", "badge": "c585d03b3_badge", "pulse": "c6a86eeb3_pulse", "executor": "c821b0a53_executor", "time": "c9394b1b0_time", "summary": "c0ccb5df0_summary", "rowActions": "c6501421a_rowActions", "copyId": "c2f8fb5c1_copyId", "detail": "cd2f5be34_detail", "detailBrief": "c8c28c2c9_detailBrief", "detailAttempts": "c40355da6_detailAttempts", "detailError": "ca6a57656_detailError", "detailOutput": "cb249b09a_detailOutput", "empty": "c52c64ffd_empty", "error": "cb08d66df_error", "loading": "ca91ac836_loading" };
...
function attemptStep(attempt) {
  const parts = [`\u7B2C ${attempt.n} \u6B21`, statusLabel2(attempt.status)];
...
function CoAgentHubTaskPanel({ apiBase = DEFAULT_API_BASE }) {
  ...
  (0, import_react2.useEffect)(() => {
    ...
    fetchTasks(apiBase, groupId).then(
      (tasks2) => {
        if (alive) setState({ kind: "ready", tasks: tasks2 });
      },
      (error) => {
        if (alive) setState({ kind: "error", message: error instanceof Error ? error.message : String(error) });
      }
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: CoAgentHubTaskPanel_default.body, children: [
      ...
      state.kind === "ready" && tasks.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("ul", { className: CoAgentHubTaskPanel_default.list, children: tasks.map((task) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("li", { children: [
          ...
          expanded && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: CoAgentHubTaskPanel_default.detail, children: [
            briefText(task) !== "" && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: CoAgentHubTaskPanel_default.detailBrief, children: briefText(task) }),
            task.attempts.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: CoAgentHubTaskPanel_default.detailAttempts, children: attemptTimeline(task.attempts) }),
            diffError !== "" && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("pre", { className: CoAgentHubTaskPanel_default.detailError, children: capOutput(diffError) }),
            diffOutput !== "" && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("pre", { className: CoAgentHubTaskPanel_default.detailOutput, children: capOutput(diffOutput) }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: CoAgentHubTaskPanel_default.rowActions, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
              "button",
              {
                type: "button",
                className: CoAgentHubTaskPanel_default.copyId,
...
function CoAgentHubPanel({ apiBase = DEFAULT_API_BASE }) {
  const [tab, setTab] = (0, import_react4.useState)("groups");
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("section", { className: CoAgentHubPanel_default.panel, "aria-label": "CoAgentHub \u9762\u677F", children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("header", { className: CoAgentHubPanel_default.header, children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("h2", { className: CoAgentHubPanel_default.title, children: "CoAgentHub" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: CoAgentHubPanel_default.tabs, role: "tablist", "aria-label": "\u9762\u677F\u5207\u6362", children: PANEL_TABS.map(({ id, label }) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        "button",
        {
          type: "button",
          role: "tab",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: CoAgentHubPanel_default.body, children: [
      tab === "groups" && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(CoAgentHubGroupList, { apiBase }),
      tab === "tasks" && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(CoAgentHubTaskPanel, { apiBase }),
      tab === "executors" && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(CoAgentHubExecutorsPanel, { apiBase })
    ] })
  ] });
}
